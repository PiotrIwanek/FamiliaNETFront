...
export class NewsComponent implements OnInit{
  ...
  news: Post[];
  public  postText: string = 'Treść';

  public postTitle: string = 'Tytuł';

  public selectedPost: Post = Post.prototype;

  public items: MenuItem[];

  public authorized: boolean;
  public  isFileDelete: boolean;
  public isPostCreated: boolean;
  public isPostEdit: boolean;

  public  selectedPrioryty;
  public  unitsList: Unit[];
  public selectedUnits: Unit[];
  public  selectedCategoryForPost;
  public treeNode: TreeNode = TreeNode.prototype;

  public fileIdToDelete: string;
  public  postIdToDeleteFile: string;

  public categoryTree: Category = Category.prototype;

  public isFileListEdit: boolean;
  public fileToUpload: File[];
  public listOfPostFiles: Array<any>;
  ...
  constructor(private postService: PostService, private catService: CategoryService, private dataService: DataService
    , private fileService: FileDBService, private message: MessageService, private unitService: UnitService) {
  }
  ...
  ngOnInit(): void {
    ...
    this.unitService.getAll().subscribe(data => this.unitsList = data);
  ...
  sendPost() {
    try {
      ...
      if (this.uploadFiles.length !== 0) {
        ...
        this.postService.addNews(new Post(null, this.postTitle, this.postText, new Date(), new Date(),
          false, null, "MEDIUM",
          [], [], [], this.selectedUnits))
        .subscribe(response => {
        ...
        this.postService.addNews(new Post(null, this.postTitle, this.postText, new Date(), new Date(),
          false, null, "MEDIUM",
          [], [], [], this.selectedUnits)).subscribe(response => {
          this.news.push(response);
          console.log(response);
        });
        this.selectedUnits = [];
